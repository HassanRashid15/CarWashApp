...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This sets a cookie to persist the sidebar state.
        ...
        >
          <div
            ...
            className={cn(
              ...
              "group-data-[variant=inset]:border-sidebar-border group-data-[variant=inset]:border-r"
            )}
          >
            {children}
          </div>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "mx-2 w-auto shrink-0 bg-sidebar-border transition-all duration-200 ease-linear [&>div]:bg-sidebar-border",
        "group-data-[collapsible=icon]:mx-2 group-data-[collapsible=icon]:w-6",
        className
      )}
    >
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "px-3 transition-[width,height,padding] group-data-[collapsible=icon]:px-2",
        "py-4 group-data-[collapsible=icon]:py-2",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:-mt-4 group-data-[collapsible=icon]:mb-1 group-data-[collapsible=icon]:h-0 group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:px-2 group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        {...tooltip}
        className={cn("ml-4", tooltip.className)}
      />
    </Tooltip>
  )
})
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground [@media(pointer:coarse)]:opacity-100",
    ...
    >
      {showIcon && (
        <div
          ...
          className="flex h-4 w-4 shrink-0 animate-pulse rounded-md bg-sidebar-primary/10"
        />
      )}
      <div
